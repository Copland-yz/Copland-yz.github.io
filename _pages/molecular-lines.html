---
layout: single
title: "Molecular Emission Lines Search"
permalink: /molecular-lines/
author_profile: false
---

<style>
/* Override theme to use full width only on this page */
.molecular-lines-page .page {
    width: 100% !important;
    padding-right: 0 !important;
}

.molecular-lines-page .page__inner-wrap {
...
<div class="search-container molecular-lines-container">
    <div class="search-params">
        <div class="param-group">
            <label for="wavelength-min">Wavelength (nm)</label>
            <div class="range-inputs">
                <input type="number" id="wavelength-min" placeholder="Min" step="0.1">
                <span>to</span>
                <input type="number" id="wavelength-max" placeholder="Max" step="0.1">
            </div>
        </div>
        
        <div class="param-group">
            <label for="frequency-min">Frequency (GHz)</label>
            <div class="range-inputs">
                <input type="number" id="frequency-min" placeholder="Min" step="0.001">
                <span>to</span>
                <input type="number" id="frequency-max" placeholder="Max" step="0.001">
            </div>
        </div>
        
        <div class="param-group">
            <label for="molecule-name">Molecule/Ion</label>
            <input type="text" id="molecule-name" placeholder="e.g., CO, H2O, OH">
        </div>
    </div>
    
    <h3>Select Elements</h3>
    <p>Click once to <strong>include</strong> an element, click twice to <strong>exclude</strong> it, click again to reset.</p>
    
    <div class="legend">
        <div class="legend-item">
            <span class="legend-color" style="background: #f9f9f9; border: 1px solid #ccc;"></span>
            Not Selected
        </div>
        <div class="legend-item">
    ...
    <div style="text-align: center;">
        <button class="search-button" onclick="performSearch()">Search Emission Lines</button>
        <button class="search-button" style="background: #9E9E9E;" onclick="resetElements()">Reset Elements</button>
    </div>
    
    <div class="results-section">
        <h3>Search Results</h3>
        <div id="search-results">
            <p>Enter search parameters and click "Search Emission Lines" to find molecular emission lines.</p>
        </div>
    </div>
</div>

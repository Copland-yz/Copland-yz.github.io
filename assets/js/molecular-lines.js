...
function generatePeriodicTable() {
    console.log('Starting periodic table generation...');
    const table = document.getElementById('periodic-table');
    if (!table) {
        console.error('Could not find periodic-table element!');
        return;
    }
    console.log('Found periodic table element, clearing content...');
    table.innerHTML = '';
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM loaded, initializing periodic table...');
    // Add class to body for CSS scoping
    document.body.classList.add('molecular-lines-page');
    generatePeriodicTable();
    console.log('Periodic table generation completed');
});